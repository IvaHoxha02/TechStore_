...
public class Login{
	public Scene exec(Stage primaryStage){
		...
		Image nameAvatar = new Image("file:///C:/Users/Dorin/OneDrive/Desktop/java/TechStore/src/resources/images/user-login.png",25,25,false,false);
		...
		Image passwordAvatar = new Image("file:///C:/Users/Dorin/OneDrive/Desktop/java/TechStore/src/resources/images/lock.png",25,25,false,false);
		...
		vertical.getChildren().addAll(info_name,info_password,login,err);
	    ...
	    mainPane.setStyle("-fx-background-image: url('file:///C:/Users/Dorin/OneDrive/Desktop/java/TechStore/src/resources/images/login2.jpg');");
